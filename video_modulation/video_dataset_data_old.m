...
% May 2015
% 8.5.0.197613 (R2015a)
function video_sequence = video_dataset_data()
etdb_video_sequence=struct('name',... 
...
orig_video_sequence=struct('name',... 
    {'orig_bridge_close',...
...
video_sequence=[etdb_video_sequence, orig_video_sequence];
end
