...
void Markver2c2(cv::Mat Sali,const cv::Mat img,int q);
void checktop2(int x, int y,int q);
void Markver2c(cv::Mat Sali,const cv::Mat img,int q);
...
void checktop2(int x, int y,int q){
	...
	if (mask.data[int(mask.cols*y*16+x*16+y2*mask.cols+x2)]>150){
